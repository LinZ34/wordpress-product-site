...
<?php get_template_part( 'include/header-diversity-child' ); ?>
    ...
    <div class="download-container">
        <div class="download-left">
            ...
            <img src="<?php pdt_img_dir() ?>/diversity/dv-product.png">
            </div>
        ...
        この度は弊社サービスへのお問い合わせありがとうございます。弊社担当から折り返しご連絡いたします。
				...
				<script>
				  hbspt.forms.create({
					portalId: "6399170",
					formId: "78cf2183-65c9-44e3-9277-db99ddcf72fc"
				});
				</script>
                </div>
        </div>
    ...
    <?php get_template_part( 'include/contactbtn-diversity-child-child' ); ?>
    </main>
