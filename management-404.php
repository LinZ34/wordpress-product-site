...
<div class="keyvisual" id="home">
    ...
    <div class="img">
      <img src="<?php img_dir() ?>/product/management/404-mg.png">
    </div>
  </div>
  <div class="buttons">
		  <a href="<?= HOME_PATH ?>/management" class="a-text">TOPページへ</a>
  </div>
  <?php get_template_part( 'include/contactbtn-management' ); ?>
    </main>
    <?php get_template_part( 'include/footer-management' ); ?>
<?php get_footer('product'); ?>
<?php
    echo '<link rel="stylesheet" href="' . TEMP_DIR . '/css/product/bottom-management.css">';
    ...
    echo '<link rel="stylesheet" href="' . TEMP_DIR . '/css/product/mg-404.css">';
?>