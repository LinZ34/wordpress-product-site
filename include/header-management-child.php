	...
	<div class="header_items">
		...
		<div class="header_menu">
			<nav class="header_menu_nav">
    			...
    			<a href="<?= HOME_PATH ?>/management/" class="text">Home</a></li>
				<li class="header_menu_listitem">
				<a href="<?= HOME_PATH ?>/management/usage/" class="text<?php echo (is_tree(get_page_by_path('management')->ID) && is_page('usage')) ? ' current' : '' ?>">診断結果の活用</a>
				</li>
				<li class="header_menu_listitem">
				<a href="<?= HOME_PATH ?>/management/reason/" class="text<?php echo (is_tree(get_page_by_path('management')->ID) && is_page('reason')) ? ' current' : '' ?>">診断の論拠</a>
				</li>
				<li class="header_menu_listitem">
